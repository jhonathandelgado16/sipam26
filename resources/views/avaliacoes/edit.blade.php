...
@section('content')
    ...
    {!! Form::open(['route' => 'avaliacao.update', 'method' => 'PATCH']) !!}
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 text-center row justify-content-center">
        <button id="button-salvar" type="submit" class="col-3 btn btn-sipam text-large">Editar avaliação</button>
    </div>
    </div>
    {!! Form::close() !!}
