...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Adicionar Curso de Formação</h2>
        </div>
...
{!! Form::open(array('route' => 'cursos_formacao.store','method'=>'POST')) !!}
<div class="row justify-content-center">
    <div class="col-5">
        <div class="form-group">
            <strong>Nome do Curso:</strong>
            {!! Form::text('nome', null, array('placeholder' => 'Ex: CFSD','class' => 'form-control')) !!}
        </div>
    </div>
    <div class="col-2">
        <div class="form-group">
