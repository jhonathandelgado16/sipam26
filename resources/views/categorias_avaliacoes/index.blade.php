                ...
                <div class="col-lg-12 margin-tb">
                    <div class="row">
                        ...
                        <div class="row justify-content-end col-4">
                            @can('admin')
                                <a class="col-7 btn btn-primary" href="{{ route('categorias_avaliacoes.create') }}">Adicionar
                                    Categoria</a>
                            @endcan
                        </div>
                    </div>
    ...
    <table class="table text-center">
        ...
        @foreach ($categorias_avaliacoes as $categoria_avaliacao)
            <tr>
                ...
                <td>
                    @can('admin')
                        <a class="btn btn-white" href="{{ route('categorias_avaliacoes.edit', $categoria_avaliacao->id) }}"><img
                                src="{{ url('storage/icons/edit.png') }}" height="20"> Editar</a>
                        
                        <a class="btn btn-white" href="{{ route('categorias_avaliacoes.definir', $categoria_avaliacao->id) }}"><ion-icon name="person-add"></ion-icon> Definir Atributos</a>
